...
static void isr(void)
{
	...
	if (next_low < 255) {
		digitalWrite(next_low, LOW_STATE);
	}
	...
	//if (channel == __builtin_ctz(servo_active_mask)) {
		//digitalWrite(2, HIGH_STATE);
		//delayMicroseconds(1);
		//digitalWrite(2, LOW_STATE);
	//}
